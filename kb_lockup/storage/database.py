...
from kb_lockup.core.models import LockupData, LockupEntry, Company, ReminderConfig
from kb_lockup.core.exceptions import DatabaseError
from kb_lockup.storage.migrations import SCHEMA_SQL
...
class Database:
    ...
    async def get_company(self, corp_code: str) -> Optional[Company]:
        ...
        from kb_lockup.core.models import Market
        return Company(
